...
--src_path /projects/bodymaps/Data/CT_RATE/ct_rate_nnunet_cts_pancreas_n_some_normals/ \
--label_path /projects/bodymaps/Data/CT_RATE/ct_rate_nnunet_labels_pancreas_n_some_normals_split/ \
--tgt_path /projects/bodymaps/Data/CT_RATE/ct_rate_pancreas_medformer/ --workers 16 \
