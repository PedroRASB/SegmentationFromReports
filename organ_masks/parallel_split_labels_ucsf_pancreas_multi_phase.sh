...
--input_dir /projects/bodymaps/Data/masks_multi_phase/pancreas_cases/multi_phase_pdac_epai_nnunet_masks/ \
--output_dir /projects/bodymaps/Data/masks_multi_phase/pancreas_cases/multi_phase_pdac_epai_nnunet_masks_split/ \
--parts 20 --part ${PART_ID} > slurm_logs/split_labels_part_${PART_ID}.out \
