...
--input_dir /projects/bodymaps/Data/UCSF_with_tumor_slices/UCSF_series_with_slice_masks_nnunet/ \
--output_dir /projects/bodymaps/Data/UCSF_with_tumor_slices/UCSF_series_with_slice_masks_nnunet_split/ \
