...
python split_labels.py --input_dir /projects/bodymaps/Data/CT_RATE/ct_rate_nnunet_labels_pancreas_n_some_normals \
--output_dir /projects/bodymaps/Data/CT_RATE/ct_rate_nnunet_labels_pancreas_n_some_normals_split \
