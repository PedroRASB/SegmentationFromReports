...
python split_labels.py --input_dir /projects/bodymaps/Data/Merlin/merlin_nnunet_labels/ \
 --output_dir /projects/bodymaps/Data/Merlin/merlin_nnunet_labels_split/ \
--parts 20 --part ${PART_ID} > slurm_logs/merlin_split_labels_part_${PART_ID}.out \
    2> slurm_logs/merlin_split_labels_part_${PART_ID}.err
