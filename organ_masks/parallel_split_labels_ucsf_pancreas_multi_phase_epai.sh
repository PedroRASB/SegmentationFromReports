...
--input_nnunet_gt_path /projects/bodymaps/Data/masks_multi_phase/pancreas_cases/multi_phase_pdac_epai_masks_epai/ \
--output_bdmap_gt_path /projects/bodymaps/Data/masks_multi_phase/pancreas_cases/multi_phase_pdac_epai_masks_epai_split/ \
